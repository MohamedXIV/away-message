...
- **Rules decide, AI paraphrases.** All canonical game decisions are deterministic rules + seeded rolls. AI may interpret/phrase only through explicitly approved semantic surfaces. Never let the model own relationships, goals, obligations, current location, routes, fares, schedule truth, item/money changes, event truth, or consequence commits.
